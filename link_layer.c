...
static int transmission_frame_disc(int fd, frame send,int length);
...
//FUNCAO GENERICA QUE TRATA DA RECEPCAO DA FRAME HEADER  -> STATEMACHINE CALLS, ETC
